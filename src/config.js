...
exports.owner = {
    ...
    "id": "1824687511110288" // ID of bot owner (for secure commands, reports, and alerts)
};

// Bot information
exports.bot = {
    "names": {
        "short": "Sera", // Will be used as 'nickname' in chat (remove if same as account name)
        "long": "Hey Sera" // Name displayed in profile on bot's Facebook account
    },
    "id": "535470537374679" // Bot's ID (for security purposes in commands)
};
